...
import type { ExternalBlob as _ExternalBlob, Film as _Film, FilmId as _FilmId, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllFilms(): Promise<Array<Film>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFilms();
    ...
    async getFilm(arg0: FilmId): Promise<Film> {
        if (this.processError) {
            try {
                const result = await this.actor.getFilm(arg0);
                return from_candid_Film_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getFilmCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getFilmCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadFilm(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: ExternalBlob, arg5: ExternalBlob): Promise<FilmId> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFilm(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n16(this._uploadFile, this._downloadFile, arg4), await to_candid_ExternalBlob_n16(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Film_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Film): Promise<Film> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        poster: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.poster)
    };
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Film>): Promise<Array<Film>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Film_n11(_uploadFile, _downloadFile, x)));
}
